...
function NextArrow(props) {
  ...
  return (
    <button
      ...
      onClick={onClick}
      onMouseOver={e => {
        e.currentTarget.style.background = '#002a85';
        e.currentTarget.style.transform = 'scale(1.05)';
      }}
      onMouseOut={e => {
        e.currentTarget.style.background = '#0036b1';
...
const slides = [
    ...
    <div className="max-w-6xl mx-auto w-full flex flex-col items-center justify-center">
      ...
      <div className="flex items-center justify-center gap-6 md:gap-12 mb-4 md:mb-8">
        <img 
          ...
          style={{
            maxWidth: '35vw',
            filter: 'drop-shadow(0 10px 15px rgba(0, 54, 177, 0.15))'
          }}
        />
        <div className="flex flex-col items-center">
          <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-r from-[#0036b1] to-[#002a85] flex items-center justify-center mb-2 shadow-lg transform hover:scale-105 transition-all duration-300">
          ...
          <p className="text-xs md:text-sm font-semibold text-[#0036b1] text-center">Strategic Partnership</p>
        </div>
        <img 
          src="https://i.imgur.com/nI9XHcY.png" 
          alt="Geodis Logo" 
          className="w-24 md:w-48 drop-shadow-xl" 
          style={{
            maxWidth: '35vw',
      ...
      <div className="text-center mb-4 md:mb-8">
        <h1 className="text-xl md:text-5xl font-extrabold tracking-tight mb-2 md:mb-4 leading-tight">
          <div className="flex flex-col md:flex-row md:gap-2 justify-center items-center">
            <span className="text-[#0036b1] whitespace-nowrap">Full Truckload.</span>
            <span className="text-[#0036b1] whitespace-nowrap">Less Than Truckload.</span>
      ...
      <a 
        href="#contact" 
        className="bg-[#0036b1] text-white px-5 py-2.5 md:px-6 md:py-3 rounded-full font-bold text-sm md:text-base shadow-lg hover:bg-[#002a85] transition-all duration-300 mb-4 md:mb-8 transform hover:scale-105 whitespace-nowrap"
      >
        Let's Move Forward Together
      </a>

      {/* Client Badge */}
      <ClientBadge clientName="Geodis SCO USA" />
    </div>
  </section>,
  ...
  <section className="flex flex-col justify-center items-center px-3 py-4 md:p-6 bg-white min-h-screen">
    <div className="max-w-6xl mx-auto w-full">
      <h1 className="text-3xl md:text-5xl font-extrabold text-[#0036b1] mb-2 md:mb-3 text-center tracking-tight">About <span className="text-black">USKO</span></h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-4">
        ...
        <div className="space-y-3 md:space-y-4 order-1 md:order-2">
          <div className="bg-gray-50 rounded-xl p-3 md:p-4 shadow-lg">
            <h3 className="text-lg md:text-xl font-semibold text-[#0036b1] mb-3">Company Highlights</h3>
            <div className="grid grid-cols-3 gap-2 md:gap-3">
              <div className="text-center">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#0036b1] flex items-center justify-center text-white font-bold text-sm md:text-base mx-auto shadow-md">
                  18
                </div>
  ...
  <section className="flex flex-col justify-center items-center px-3 py-4 md:p-8 bg-white min-h-screen">
    <div className="max-w-6xl mx-auto w-full">
      <div className="bg-[#0036b1]/10 p-3 md:p-4 rounded-lg border border-[#0036b1]/30 mb-4 md:mb-6 text-center">
        <h1 className="text-3xl md:text-5xl font-extrabold text-[#0036b1] mb-2 text-center tracking-tight">Our <span className="text-black">Transportation Fleet</span></h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-4 md:mt-6">
        <div className="bg-gray-50 rounded-xl p-6 shadow-lg">
          <div className="flex items-center mb-4">
            <div className="w-12 h-12 rounded-full bg-[#0036b1] flex items-center justify-center text-white mr-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-[#0036b1]">Express LTL & Full Truckload</h3>
          </div>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#0036b1] mr-3 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-gray-50 rounded-xl p-6 shadow-lg relative">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#0036b1]">Expedite White Glove Services</h3>
          </div>
        ...
        <div className="bg-gray-50 rounded-xl p-4 shadow-lg md:col-span-2">
          <div className="flex items-center mb-3">
            <div className="w-10 h-10 rounded-full bg-[#0036b1] flex items-center justify-center text-white mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-[#0036b1]">Why Choose USKO for Geodis SCO USA?</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="border-l-4 border-[#0036b1] pl-3">
  ...
  <section className="flex flex-col justify-center items-center px-8 md:px-24 py-4 md:py-8 bg-white min-h-screen">
    <div className="max-w-6xl mx-auto w-full">
      <div className="bg-[#0036b1]/10 p-3 md:p-4 rounded-lg border border-[#0036b1]/30 mb-4 md:mb-6 text-center">
        <h1 className="text-3xl md:text-5xl font-extrabold text-[#0036b1] mb-2 text-center tracking-tight">Our <span className="text-black">Network</span></h1>
      ...
      <div className="mt-4 md:mt-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
          <div className="bg-gray-50 p-3 md:p-4 rounded-xl shadow-lg flex flex-col items-center">
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#0036b1] flex items-center justify-center text-white mb-3">
        ...
        <div className="mt-4 bg-[#0036b1]/5 p-4 rounded-xl border border-[#0036b1]/20 shadow-lg text-center">
          <p className="text-gray-700 text-sm">
            All USKO branches are strategically positioned to provide optimal coverage for Geodis SCO USA shipments.
          </p>
        </div>
      </div>
    </div>
  ...
  <section className="flex flex-col justify-center items-center p-6 bg-white min-h-screen">
    <div className="max-w-6xl mx-auto w-full">
      <div className="bg-gradient-to-r from-[#0036b1] to-[#002a85] p-6 rounded-2xl shadow-2xl mb-8 transform hover:scale-[1.02] transition-all duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-[0_4px_20px_rgba(235,0,40,0.1)] hover:shadow-[0_4px_25px_rgba(235,0,40,0.15)] transition-all duration-300 border border-gray-100">
          <div className="flex items-center mb-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#0036b1] to-[#002a85] flex items-center justify-center text-white">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
            </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={index} className="flex items-center p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                <div className="w-2 h-2 rounded-full bg-[#0036b1] mr-3"></div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-[0_4px_20px_rgba(235,0,40,0.1)] hover:shadow-[0_4px_25px_rgba(235,0,40,0.15)] transition-all duration-300 border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={index} className="flex items-center p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                <div className="w-2 h-2 rounded-full bg-[#0036b1] mr-2"></div>
        ...
        <div className="bg-gradient-to-br from-[#0036b1] to-[#002a85] rounded-2xl p-6 shadow-xl md:col-span-2 transform hover:scale-[1.01] transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-colors duration-200">
                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-[#0036b1] mb-3">
                  {capability.icon}
                </div>
  ...
  <section className="flex flex-col justify-center items-center p-6 bg-white">
    <div className="max-w-6xl mx-auto w-full">
              <h1 className="text-4xl md:text-5xl font-extrabold text-[#0036b1] mb-2 text-center tracking-tight">Partnering with <span className="text-black">Geodis SCO USA</span></h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
        <div className="bg-gray-50 p-4 rounded-xl shadow-lg">
          <h3 className="text-lg font-semibold text-[#0036b1] mb-3">Our Value Proposition</h3>
          <ul className="space-y-3">
            <li className="flex">
              <div className="w-8 h-8 rounded-full bg-[#0036b1] flex-shrink-0 flex items-center justify-center text-white mr-3">
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 p-6 rounded-xl shadow-lg">
            <h3 className="text-2xl font-semibold text-[#0036b1] mb-4">Key Benefits for Geodis SCO USA</h3>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
                <div className="w-12 h-12 rounded-full bg-[#0036b1]/10 flex items-center justify-center mb-3">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#0036b1]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-[#0036b1]/5 p-6 rounded-xl border border-[#0036b1]/20">
            <div className="flex items-center mb-3">
              <div className="w-10 h-10 rounded-full bg-[#0036b1] flex items-center justify-center text-white mr-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-[#0036b1]">Did You Know?</h3>
            </div>
  ...
  <section className="flex flex-col justify-center items-center px-3 py-4 md:p-8 pb-16 bg-white min-h-screen">
    <div className="max-w-6xl mx-auto w-full">
      <div className="text-center mb-6 md:mb-8">
        <h1 className="text-3xl md:text-5xl font-extrabold text-[#0036b1] mb-3 md:mb-4">Ready to Transform Your <span className="text-black">Logistics Experience?</span></h1>
        <h2 className="text-lg md:text-2xl text-gray-700 mb-4 md:mb-6 max-w-3xl mx-auto font-semibold">
          Partner with USKO to elevate Geodis SCO USA's transportation capabilities with our specialized fleet and white glove delivery teams.
        </h2>
      </div>

      {/* USKO Family of Companies Section */}
      <div className="bg-[#0036b1]/5 p-4 md:p-6 rounded-xl border border-[#0036b1]/20 shadow-lg mx-auto max-w-3xl mb-6 md:mb-8">
        <div className="flex items-center mb-4">
          <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#0036b1] flex items-center justify-center text-white mr-3 md:mr-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
          </div>
          <h3 className="text-lg md:text-xl font-semibold text-[#0036b1]">USKO Family of Companies</h3>
        </div>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
            ...
            <div className="col-span-1 md:col-span-2 h-4 md:h-8 flex justify-center">
              <div className="w-px h-full bg-[#0036b1]/20"></div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
        <div className="bg-gray-50 rounded-xl p-4 md:p-6 shadow-lg text-center">
          <div className="mx-auto w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#0036b1] flex items-center justify-center text-white mb-3 md:mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          ...
          <p className="font-bold text-[#0036b1] text-base md:text-lg">+1 (916) 849-2156</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-4 md:p-6 shadow-lg text-center">
          ...
          <p className="font-bold text-[#0036b1] text-base md:text-lg">ron@uskoinc.com</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-4 md:p-6 shadow-lg text-center">
          ...
          <div className="flex flex-col items-center">
            <p className="font-bold text-[#0036b1] text-base">1101 CREEKSIDE RIDGE DR STE&nbsp;270</p>
            <p className="font-bold text-[#0036b1] text-base">ROSEVILLE, CA 95678</p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center mt-4 md:mt-6 mb-8 md:mb-12">
        ...
        <h4 className="text-xl md:text-2xl font-bold text-[#0036b1]">Logistics. Delivered. <span className="text-black">Exceptionally.</span></h4>
      </div>
    </div>
  </section>,
];
        ...
        {slides.map((slide, idx) => (
          <div key={idx} className="relative min-h-screen">
            ...
            <div className="page-indicator absolute bottom-2 right-2 bg-white/80 px-2 py-1 rounded-full text-sm">
              <span className="text-[#0036b1] font-bold">{idx + 1}</span>
